...
var UIController = (function(){
            ...
            //FORMATING THE NUMBER WITH + OR -, 2-decimal Point, and Comma for THOUSANDS
           var formatNumber = function(num, type){
               ...
               int = numSplit[0];
               if (int.length > 3){
                   //Comma Rule e.g. 23,503 or 2,593
        ...
        return {
            ...
            clearFields: function(){
                ...
                fieldsArr[0].focus(); // To return focus
            },
...
var controller = ( function(budgetCtrl, UICtrl){
        ...
        var ctrlAddItem = function(){
                    ...
                    newItem = budgetCtrl.addItem(input.type, input.description, input.addValue);
